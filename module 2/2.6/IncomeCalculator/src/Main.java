...
public class Main {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 4; i++) {
            // запрос суммы от пользователя
            System.out.println("Введите сумму доходов компании за месяц " +
                "(от 200 до 900 тысяч рублей): ");
            // int income = 500917;
            int income = (new Scanner(System.in)).nextInt();

            // если сумма больше или меньше ограничений - выводится ошибка и программа возвращается в начало цикла for
            if (!checkIncomeRange(income)) {
                continue;
            }

            // если ошибок нет, то идет расчет
